...
function Sidebar({ openSidebarToggle, OpenSidebar }) {
  return (
    <aside
      ...
      } transition-transform duration-200 ease-in-out bg-purple-900 text-white w-64 z-30`}
    >
      ...
      <nav className="mt-10">
        <Link
          to="/home"
          className="flex items-center py-2 px-6 text-sm text-white hover:bg-purple-700"
        >
